...
<template>
  ...
  <div class="flex flex-col gap-24" data-testpl="checkout-login">
    <h2 data-testpl="checkout-login-title">
    ...
    >
      ...
      <BaseInput
        ...
        data-testpl="checkout-login-totp-input"
      />

      <BaseButton
        type="submit"
        class="mt-12 w-full"
        data-testpl="checkout-login-totp-form-btn"
    ...
    <form
      ...
      data-testpl="checkout-login-form"
    ...
    >
      <BaseInput
        ...
        name="email"
        autocomplete="email"
        data-testpl="checkout-login-email-input"
      />
      ...
      <BaseInput
        ...
        data-testpl="checkout-login-password-input"
      >
        <template #append>
          <Transition
            mode="out-in"
      ...
      <RouterLink
        ...
        data-testpl="checkout-login-forgot-password-btn"
      >
        {{ $t('forgotPassword') }}?
      </RouterLink>
      ...
      <BaseButton
        type="submit"
        class="mt-12 w-full"
        data-testpl="checkout-login-submit-form-btn"
        :loading="userStore.loginLoading"
      >
        {{ $t('login') }}
      </BaseButton>
    ...
    <BaseButton
      ...
      data-testpl="checkout-login-back-to-login-btn"
      @click="backToLogin"
    >
      {{ $t('backToLogin') }}
    </BaseButton>
    ...
    <div
      ...
      class="flex flex-col gap-12"
      data-testpl="checkout-login-alternative"
    >
      <BaseButton
        v-if="googleAuthEnabled"
        theme="outline"
        :loading="userStore.loginGoogleLoading"
        data-testpl="checkout-login-alternative-google-btn"
      ...
      <BaseButton
        ...
        theme="outline"
        data-testpl="checkout-login-alternative-apple-btn"
      >
        <template #prepend>
    ...
    <p class="text-14 flex justify-center gap-4" data-testpl="checkout-login-first-time">
      ...
      <button
        ...
        type="button"
        @click="emit('register')"
        data-testpl="checkout-login-first-btn"
      >
        {{ $t('createAnAccount') }}
      </button>
    </p>
