...
<template>
  <div class="flex h-full flex-col" data-testpl="sign-up">
    <div class="m-auto flex w-full max-w-424 flex-col gap-24" data-testpl="sign-up-container">
      <h1 class="text-21 lg:text-26 font-secondary" data-testpl="sign-up-title">
        {{ $t('welcomeToKINSYN') }}
      </h1>
      ...
      <form class="grid grid-cols-2 gap-12" @submit.prevent="onSubmit">
        <BaseInput
          ...
          autocomplete="off"
          data-testpl="sign-up-first-name-input"
        />
        ...
        <BaseInput
          ...
          autocomplete="off"
          data-testpl="sign-up-last-name-input"
        />
        ...
        <BaseInput
          ...
          name="email"
          autocomplete="off"
          data-testpl="sign-up-email-input"
        />
        ...
        <BaseOtpInput
          ...
          data-testpl="sign-up-verification-code-input"
        ...
        <BaseInput
          ...
          name="password"
          autocomplete="off"
          data-testpl="sign-up-password-input"
        >
          <template #append>
        ...
        >
          <p class="text-12 text-secondary-text" data-testpl="sign-up-terms-and-conditions">
        ...
        <BaseCheckbox v-model="formData.consentEmailGeneralMarketing" class="col-span-full">
          <p class="text-12 text-secondary-text" data-testpl="sign-up-consent-email">
        ...
        <BaseButton
          type="button"
          class="col-span-full mt-12"
          data-testpl="sign-up-send-code-btn"
          size="48"
        ...
        >
          ...
          <span v-if="time" data-testpl="sign-up-send-code-time">
            {{ time }}
          </span>
        </BaseButton>
        ...
        <BaseButton
          ...
          type="submit"
          class="col-span-full"
          data-testpl="sign-up-submit-form-btn"
      ...
      <template v-if="googleAuthEnabled || appleAuthEnabled">
        <p class="flex w-full items-center gap-24" data-testpl="sign-up-or">
        ...
        <div class="flex flex-col gap-12" data-testpl="sign-up-alternative">
          <BaseButton
          ...
          <BaseButton
            ...
            theme="outline"
            data-testpl="sign-up-alternative-apple-btn"
          >
            <template #prepend>
      ...
      <p class="text-14 flex justify-center gap-4" data-testpl="sign-up-have-account">
        <span>{{ $t('doYouHaveAnAccount') }}</span>

        <RouterLink
          :to="{ name: 'Login' }"
          class="text-link-text font-medium"
          data-testpl="sign-up-login-btn"
        >
          {{ $t('login') }}
        </RouterLink>
      </p>
